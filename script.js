...
// Timeline tidak dijalankan otomatis
var tl = gsap.timeline({ paused: true });

tl.set("#Footer_group_1_", { autoAlpha: 1 })
  // ... (lanjutan animasi seperti semula)
...
document.getElementById("gift-btn").addEventListener("click", function () {
  ...
  // Mulai animasi timeline GSAP
  tl.play();

  // Tampilkan pesan setelah animasi mulai
  setTimeout(() => {
    gsap.to("#flower-message", { autoAlpha: 1, duration: 2 });
  }, 4000);
});
